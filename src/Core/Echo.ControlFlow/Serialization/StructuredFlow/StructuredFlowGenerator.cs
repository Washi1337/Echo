...
namespace Echo.ControlFlow.Serialization.StructuredFlow
{
    ...
    {
        private sealed class NodeComparer : IComparer<DominatorTreeNode>
        {
            public DominatorTreeNode CurrentTreeNode
            {
                get;
                set;
            }
            ...
            public int Compare(DominatorTreeNode x, DominatorTreeNode y)
            {
                ...
                var fallThroughEdge = CurrentTreeNode.OriginalNode.GetFallThroughEdge();
        ...
        public ScopeBlock<TInstruction> Generate(ControlFlowGraph<TInstruction> cfg)
        {
            ...
            while (agenda.Count > 0)
            {
                ...
                comparer.CurrentTreeNode = current;
