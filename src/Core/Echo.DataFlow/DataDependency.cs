...
namespace Echo.DataFlow
{
    ...
    public class DataDependency<TContents> : IDataDependency, ISet<DataFlowNode<TContents>>
    {
        ...
        private bool AddImpl(DataFlowNode<TContents> item)
        {
            switch (_listObject)
            {
                case null:
        ...
        {
            private readonly DataDependency<TContents> _collection;
            ...
            public Enumerator(DataDependency<TContents> collection)
            {
