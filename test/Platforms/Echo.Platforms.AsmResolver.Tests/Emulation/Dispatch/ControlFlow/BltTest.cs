...
{
    public class BltTest : DispatcherTestBase
    {
        public BltTest(MockModuleProvider moduleProvider)
            : base(moduleProvider)
        {
        }

        [Theory]
        [InlineData(CilCode.Blt, 0, 0, false)]
        [InlineData(CilCode.Blt_Un, 0, 0, false)]
        [InlineData(CilCode.Blt, 0, 1, true)]
        [InlineData(CilCode.Blt_Un, 0, 1, true)]
        [InlineData(CilCode.Blt, 0, -1, false)]
        [InlineData(CilCode.Blt_Un, 0, -1, true)]
