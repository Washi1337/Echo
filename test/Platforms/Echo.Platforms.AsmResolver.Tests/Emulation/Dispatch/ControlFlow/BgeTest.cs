...
namespace Echo.Platforms.AsmResolver.Tests.Emulation.Dispatch.ControlFlow
{
    public class BgeTest : DispatcherTestBase
    {
        ...
        [Theory]
        [InlineData(CilCode.Bge, 0, 0, true)]
        [InlineData(CilCode.Bge_Un, 0, 0, true)]
        [InlineData(CilCode.Bge, 1, 0, true)]
        [InlineData(CilCode.Bge_Un, 1, 0, true)]
        [InlineData(CilCode.Bge, -1, 0, false)]
        [InlineData(CilCode.Bge_Un, -1, 0, true)]
